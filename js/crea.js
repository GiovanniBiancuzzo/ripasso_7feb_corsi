...
$(() => {//logout
    ...
    $('#convalida').on('click', function() {
        ...
        if (convalida == true) {
            ...
            $('#nuovoCorso').text(corso.corsoCompleto());//stampa attraverso il metodo corsoCompleto del corso appena creato
            ...
            $('#nuovoCorso').append('<br><span>Per visualizzare il corso appena creato e gli altri corsi <a href="corsi.html">Clicca qui</a></span>');
        }
    })
